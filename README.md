...
- Data sources and fields that could be used to explore the contribution of various factors to a customerâ€™s potential action
- What would a data frame of your choice look like â€” what should each column and row represent?
...
- Prepare a half-page summary of key findings and add some suggestions for data augmentation â€” which other data sources should the client provide you with and which open source datasets might be useful?
...
- Try to think of ways to improve the featureâ€™s predictive power and elaborate on why you made those choices
...
- What impact would the model have on the clientâ€™s bottom line? Always test what you write with the â€œso whatâ€ test
